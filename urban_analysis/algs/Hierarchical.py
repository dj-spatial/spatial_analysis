...
from urban_analysis.forms.HarchiParam import ParameterHarchi
...
class Hierarchical(QgisAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        harchi_param = ParameterHarchi(self.HARCHIPARAM, self.tr(u'참조 그래프'), layer_param=self.INPUT, linkage_param=self.LINKAGE)
        harchi_param.setMetadata({'widget_wrapper': {'class': 'urban_analysis.forms.Harchi.HarchiWidgetWrapper'}})
        harchi_param.setFlags(harchi_param.flags() | QgsProcessingParameterDefinition.FlagAdvanced)
        self.addParameter(harchi_param)

        self.cMethod = [u'군집수 기준', u'거리 기준']
