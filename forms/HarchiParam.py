...
class ParameterHarchi(QgsProcessingParameterMatrix):
    def __init__(self, name='', description='', layer_param=None, linkage_param=None, default=None, optional=False):
        QgsProcessingParameterMatrix.__init__(self, name, description)
        self.layer_param = layer_param
        self.linkage_param = linkage_param

    def clone(self):
        copy = ParameterHarchi(self.name(), self.description(), self.layer_param, self.linkage_param)
        return copy
